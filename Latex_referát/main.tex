...
\bigskip
		...
		\subsection{Simulace modelů pro různé hodnoty vstupu}
			\begin{figure}[H]
				\centering
				\includegraphics[width=\textwidth]{./Graphics/graphs/C/c_prac_bod_-0.20}\\
				\includegraphics[width=\textwidth]{./Graphics/graphs/C/c_prac_bod_0.20}
				\caption{Chování v okolí pracovního bodu}
			\end{figure}
			\begin{figure}[H]
				\centering
				\includegraphics[width=\textwidth]{./Graphics/graphs/C/c_120}
				\caption{Přechodové charakteristiky}
			\end{figure}
			\begin{figure}[H]
				\includegraphics[width=\textwidth]{./Graphics/graphs/C/c_stat_char}
		...
		\subsection{Určení přenosu}
			...
			\todo{časové konstanty a statické zesílení???}
			Pro tento přenos použijeme stejný postup jako u předchozího a zjistíme, že nulu nemá přenos žádnou a póly jsou totožné. Zesílení zde bude \(K=60\) a časová konstanta \todo{nevím}.
...
=======
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=.7\textwidth]{./Graphics/graphs/C2/odezva_harm_0.01.eps}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=.7\textwidth]{./Graphics/graphs/C2/odezva_harm_0.05.eps}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=.7\textwidth]{./Graphics/graphs/C2/odezva_harm_0.1.eps}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=.7\textwidth]{./Graphics/graphs/C2/odezva_harm_0.5.eps}
...
>>>>>>> parent of b3846dd... Dokončení 2c
		...
		\subsection{Experimentální hledání kritického zesílení}
			...
			\end{center}
			\todo{Chybí zakreslit nuly a póly a Bodeho charakteristiky}
